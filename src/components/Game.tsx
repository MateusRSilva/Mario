		...
		<>
			...
			<div className="h-[10vh] bg-slate-700 grid place-items-center text-slate-200">
				<div className="flex items-center gap-8">
					<div>
						Made by: 
						<a href="https://mateusreisdasilva.netlify.app/" className="underline hover:text-sky-400">
							Mateus Reis
						</a>
					</div>

					<a href="https://github.com/MateusRSilva" className="inline-block px-2 py-1 border border-slate rounded hover:text-sky-400 hover:border-sky-400">
						GitHub
					</a>
